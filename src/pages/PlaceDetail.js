...
import { Card, Image, Button, Modal, Header, Container, List } from 'semantic-ui-react'
...
handleClickRemove = () => {
  ...
  render() {
    console.log(this.props.detailPlace);
    ...
    const modalDetail = () => {
      return <Modal trigger={<Button onClick={this.handleClick} className="ui labeled icon button"><i className="book icon"></i>Detail</Button>} centered={false}>
        ...
        <Modal.Content>
          <img className="modalImage" size='large' src={detailPlace.main_media.media[0].url} />
        <Modal.Description className="detailDescription">
          ...
          <List divided animated>
            <List.Item>
              ...
              <List.Content>
                <List.Header><a href={detailPlace.references[1].url} target="_blank">Offical Website</a></List.Header>
              </List.Content>
            </List.Item>
            <List.Item>
              <List.Icon name='wikipedia w' size='small' verticalAlign='middle' />
              <List.Content>
                <List.Header><a href={detailPlace.references[0].url} target="_blank">Wikipedia Page</a></List.Header>
              </List.Content>
            </List.Item>
            <List.Item>
